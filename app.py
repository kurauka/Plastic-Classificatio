...
async def root():  
    return {  
        ...
        "endpoints": {  
            ...
            "predict": "/predict (POST) - Upload an image for plastic classification",  
            "insights": "/insights (POST) - Get recycling insights for a plastic type"  
        },  
        "documentation": "/docs for Swagger UI"  
    }  
